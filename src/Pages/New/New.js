...
const New = ({selectedBoxes, addBox, removeBox}) => {
    ...
    for(let i = 0; i< 100; i++){
        ...
        let isActive = selectedBoxes.includes(randomIds[i]);
        boxes.push(<Box id={randomIds[i]} position={[position_x, position_y, position_z]} boxGeometryArgs={[20, 20, 20]} scale={[scale_x, scale_y, scale_z]} rotation={[rotation_x, rotation_y, rotation_z]} addBox={addBox} removeBox={removeBox} selectedBoxes={selectedBoxes} isActive={isActive}/>);
    }
    // for (let i = 0; i < 100; i++) {
                            ...
                            <Header>
                                <div style={{ paddingTop: "15px", display: "flex"}}>
                                    ...
                                    <div style={{marginLeft: "auto", marginRight: "15px"}}>
                                        ...
                                        <Link to={RoutesNames.transform.path} state={{isNew: true, isUpdate: false}}> <Button>Next</Button></Link> : 
                                        <Button onClick={handleEmptyClicked}>Next</Button> }
                                    </div> 
                                </div>
                            </Header> 
                        </div>
